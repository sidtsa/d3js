                            ...
                            <>
                                <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                    <Button
                                        ...
                                        onClick={() => makeApiRequest("what is the impact of covid on lung cancer treatment")}
                                    >
                                    ...
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() => makeApiRequest("what is the impact of pandemic on the oncology treatment accessibility and adherence?")}
                                    >
                                    ...
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() => makeApiRequest("what are the emerging trends in precision oncology?")}
                                    >
