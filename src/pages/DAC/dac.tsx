...
import styles from "./dac.module.css";
import { selfserviceApi, Approaches, AskResponse, ChatRequest, ChatTurn, metadataInfoApi, metadataSetApi, EdaResponse, edaApi } from "../../api";
            ...
            <Box sx={{ height: `calc(100vh - 60px)`, backgroundImage: `url(${bgimg})` }}>
                ...
                <Box sx={{ px: 12, py: 2, bgcolor: "white" }}>
                    <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "2rem" }}>
                        ...
                        <Box>
                            <Typography
                                sx={{ color: "#105185", fontSize: "1.4rem", fontFamily: "Segoe UI", letterSpacing: "0px", opacity: 1, fontWeight: 600 }}
                            >
                                Quick and easy insights from your patient database(s)
                            </Typography>
                            <Typography
                                sx={{ color: "#105185", fontSize: "0.75rem", fontFamily: "Segoe UI", letterSpacing: "0px", opacity: 1, fontWeight: 600 }}
                            >
                                Query, visualize, and analyze your patient data with a conversational interface.
                            </Typography>
                        </Box>
                    </Box>
                </Box>
                ...
                <div className={styles.chatRoot}>
                    <div className={styles.chatContair}>
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: 2 }}>
                            <Typography variant="h6">Discover what you can do with Disease Area Coach.</Typography>
                                        ...
                                        <Box>
                                            <Paper variant="outlined" sx={{ p: 2, borderRadius: "10px" }}>
                                                <Box sx={{ display: "flex", flexDirection: "row", gap: 3 }}>
                                                    ...
                                                    <Box>
                                                        <Typography sx={{ fontWeight: 600 }}>Talk to your data</Typography>
                                        ...
                                        <Box>
                                            <Paper variant="outlined" sx={{ p: 2, borderRadius: "10px" }}>
                                                <Box sx={{ display: "flex", flexDirection: "row", gap: 3 }}>
                                                    ...
                                                    <Box>
                                                        <Typography sx={{ fontWeight: 600 }}>Visualize Data</Typography>
                                                        <Typography sx={{ fontSize: "0.65rem" }}>
                                        ...
                                        <Box>
                                            <Paper variant="outlined" sx={{ p: 2, borderRadius: "10px" }}>
                                                <Box sx={{ display: "flex", flexDirection: "row", gap: 3 }}>
                                                    ...
                                                    <Box>
                                                        <Typography sx={{ fontWeight: 600 }}>Generate Insights</Typography>
                                                        <Typography sx={{ fontSize: "0.65rem" }}>
                                ...
                                <>
                                    <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                        <Button
                                            ...
                                            onClick={() => makeApiRequest("What are the top-5 comorbidities in patients?")}
                                        >
                                            What are the top-5 comorbidities in patients?
                                        </Button>
                                    ...
                                    Exit formalities
                                        ...
                                        <Button
                                            variant="contained"
                                            sx={{ bgcolor: "white", color: "black", fontSize: "0.7rem" }}
                                            onClick={() => makeApiRequest("How has 1L changed over time 2023 vs. prior two years?")}
                                        >
                                            How has 1L changed over time 2023 vs. prior two years?
                                        </Button>
                                        <Button
                                            variant="contained"
                                            sx={{ bgcolor: "white", color: "black", fontSize: "0.7rem" }}
                                            onClick={() => makeApiRequest("What is the payer mix?")}
                                        >
