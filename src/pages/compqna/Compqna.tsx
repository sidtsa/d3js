    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const request: ChatRequest = {
                ...
                approach: Approaches.Compensation,
                overrides: {
                    ...
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <Box sx={{ my: 2, textAlign: "center", mx: 8 }}>
                                <p className={styles.disclaimerText}>This AI-powered agent is tailored to support alignment and roster queries.</p>
                                <p className={styles.disclaimerText}>
                                    While it aims for accuracy and timeliness, it’s essential to acknowledge its AI nature and not substitute for professional
                                    advice or expertise.{" "}
                                </p>
                            </Box>
                            {/* Questions */}
                            ...
                            <>
                                <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                    <Button
                                        ...
                                        onClick={() => makeApiRequest("How is my Disposable and Consumables commissions calculated ?")}
                                    >
                                        How is my Disposable and Consumables commissions calculated ?
                                    </Button>
                                    ...
                                    <Button
                                        ...
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() =>
                                            makeApiRequest("What will be my target Product commissions if i end my year at more than 100% achievement ")
                                        }
                                    >
                                        What will be my target Product commissions if i end my year at more than 100% achievement
                                    </Button>
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() => makeApiRequest("My alignment page is not loading for a position. What should I do to solve this?")}
                                    >
                                        My alignment page is not loading for a position. What should I do to solve this?
                                    </Button>
