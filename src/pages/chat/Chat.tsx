                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            {/* <SiOpenai fontSize={"120px"} fill={"rgba(0, 170, 133, 1)"} style={{ marginBottom: "20px" }} />
                            <h1 className={styles.chatEmptyStateTitle}>Chat With OpenAI Models </h1> */}
