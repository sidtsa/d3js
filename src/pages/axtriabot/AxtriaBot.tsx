...
import styles from "./AxtriaBot.module.css";
                ...
                <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "2rem" }}>
                    ...
                    <Box>
                        <Typography sx={{ color: "#105185", fontSize: "1.4rem", fontFamily: "Segoe UI", letterSpacing: "0px", opacity: 1, fontWeight: 600 }}>
                            ...
                            AI-powered help desk for Axtria DataMAx™
                        </Typography>
                            ...
                            <>
                                <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                    <Button
                                        ...
                                        onClick={() => makeApiRequest("What are the cloud providers supported in DataMAx ?")}
                                    >
                                        What are the cloud providers supported in DataMAx ?
                                    </Button>
