                ...
                <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "2rem" }}>
                    ...
                    <Box>
                        ...
                        <Typography sx={{ color: "#105185", fontSize: "0.75rem", fontFamily: "Segoe UI", letterSpacing: "0px", opacity: 1, fontWeight: 600 }}>
                            Your AI companion for literature reviews, medical writing, and medical education.
                        </Typography>
                    </Box>
                </Box>
            </Box>
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            {/* <FaLaptopMedical fontSize={"100px"} fill={"rgba(180, 50, 50, 1)"} style={{ marginBottom: "10px" }} />
                            <h1 className={styles.chatEmptyStateTitle}>MedEduAI</h1>
                            <h4 className={styles.chatEmptyStateSubTitle}>AI Assistant for Literature reviews, Medical writing, Medical education.</h4> */}

                            {/* <h2 className={styles.chatEmptyStateSubtitle}>Ask anything or try an example</h2> */}
                            <Box sx={{ textAlign: "center", my: 2, mx: 8 }}>
                                <p className={styles.disclaimerText}>
                                    This LLM-powered agent is tailored to support market research insights. While dedicated to delivering accurate and current
                                    information, it’s essential to acknowledge its AI foundation and not to substitute professional advice or expertise.{" "}
                                </p>
                            </Box>
                            ...
                            <>
                                <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                    <Button
                                        ...
                                        onClick={() => makeApiRequest("What are the current treatment options for NSCLC?")}
                                    >
                                        What are the current treatment options for NSCLC?
                                    </Button>
                                    ...
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() => makeApiRequest("Effectiveness of MAGRIT")}
                                    >
                                        Effectiveness of MAGRIT{" "}
                                    </Button>
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "white", color: "black", fontSize:"0.7rem" }}
                                        onClick={() => makeApiRequest("Emerging therapeutic agents for advanced non-small cell lung cancer")}
                                    >
