                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            >
                                AI-powered chat: Expect surprises and mistakes and verify facts for accuracy.
                            </Typography>
                                ...
                                <div key={index}>
                                    ...
                                    <div className={styles.chatMessageGpt}>
                                        <PlainAnswer
                                            ...
                                            answericon={<MdEmail fontSize={"25px"} />}
                                        />
                                    </div>
                                </div>
                            ))}
