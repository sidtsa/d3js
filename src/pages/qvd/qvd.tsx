...
import styles from "./qvd.module.css";
import Disclaimer from "../../components/Disclaimer/Disclaimer";
import { catalogueapi, Approaches, AskResponse, ChatRequest, ChatTurn, qlikapi } from "../../api";
...
const Qvd = () => {
    ...
    const [approach, setApproach] = useState<string>("qlik");
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const response = await fetch("/qvd", {
                method: "POST",
                headers: {
                        ...
                        <div className={styles.chatEmptyState}>
                            <Box sx={{ my: 2, textAlign: "center", mx: 8 }}>
                                ...
                                <p className={styles.disclaimerText}>
                                    While it aims for accuracys, it’s essential to acknowledge its AI nature and not substitute for professional advice or
                                    expertise.{" "}
                                </p>
                            </Box>
                        </div>
