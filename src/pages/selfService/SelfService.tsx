                ...
                <Box sx={{ px: 12, py: 2, bgcolor: "white" }}>
                    <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "2rem" }}>
                        ...
                        <Box>
                            ...
                            >
                                Quick and easy insights from your database
                            </Typography>
                                ...
                                <>
                                    <Box sx={{ display: "flex", flexDirection: "row", gap: "1rem", my: 2 }}>
                                        <Button
                                            ...
                                            onClick={() => makeApiRequest("Show me Total sales by Speciality")}
                                        >
                                            Show me Total sales by Speciality
                                        </Button>
                                    ...
                                    Exit formalities
                                        ...
                                        <Button
                                            variant="contained"
                                            sx={{ bgcolor: "white", color: "black", fontSize: "0.7rem" }}
                                            onClick={() => makeApiRequest("Give Total Sales and Trx count for all products")}
                                        >
                                            Give Total Sales and Trx count for all products
                                        </Button>
                                        <Button
                                            variant="contained"
                                            sx={{ bgcolor: "white", color: "black", fontSize: "0.7rem" }}
                                            onClick={() => makeApiRequest("Give me the total Trx and Nrx sales by product")}
                                        >
                                            Give me the total Trx and Nrx sales by product
                                        </Button>
